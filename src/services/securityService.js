...
class SecurityService {
  ...
  async getAccessAndRefreshToken(payLoad) {
    try {
      // Generate short-lived JWT access token (15 minutes)
      let payloadAccessToken = {
        googleId: "hardcoded123456789Access",
      ...
      if (payLoad !== null && payLoad !== undefined) {
        payloadAccessToken = {
          ...payloadAccessToken, // default values
          ...payLoad, // overwrite with provided values
        };
      }
      ...
      let payloadRefreshToken = {
        googleId: "hardcoded123456789Refresh",
        name: "Learning Node Js",
      ...
      if (payLoad !== null && payLoad !== undefined) {
        payloadRefreshToken = {
          ...payloadRefreshToken, // default values
          ...payLoad, // overwrite with provided values
        };
      }
  ...
  async reGenerateAccessTokenFromRefreshToken(refreshToken) {
    try {
      ...
      console.error(
        "SecurityService reGenerateAccessTokenFromRefreshToken::",
        error
      );
